...
### downstream changes for pp3345/gnome-with-patches
BuildRequires: libcap-ng-devel
Requires: libcap-ng

Patch3: mutter-168.diff
Patch4: mutter-189.diff
Patch5: mutter-281.diff
Patch6: mutter-283.diff
Patch7: mutter-454.diff
Patch8: mutter-460.diff
Patch9: mutter-520.diff
...
* Mon Jul 08 2019 Yussuf Khalil <dev@pp3345.net> - 3.32.2-3.2
- Add !677 "clutter: Defer actor allocations till shown" @0eab73dc

* Sun Jun 30 2019 Yussuf Khalil <dev@pp3345.net> - 3.32.2-3.1
- Rebease to  3.32.2-3.fc30
...
* Thu Jun 27 2019 Yussuf Khalil <dev@pp3345.net> - 3.32.2-2.1
- Update !575 "Honour `CLUTTER_ACTOR_NO_LAYOUT` more efficiently" @34824d1e (manually rebased)
- Rebase to 3.32.2-2.fc30

* Tue Jun 25 2019 Florian Müllner <fmuellner@redhat.com> - 3.32.2-2
- Add missing eglTerminal() call in EGLDevice error path

* Thu Jun 13 2019 Yussuf Khalil <dev@pp3345.net> - 3.32.2-1.4
- Add !568 "compositor: Don't emit size-changed when only position changes" @00d8337d

* Thu Jun 06 2019 Yussuf Khalil <dev@pp3345.net> - 3.32.2-1.3
- Add !283 "clutter-actor: Add detail to captured-event signal" @a20a0d7a

* Sun Jun 02 2019 Yussuf Khalil <dev@pp3345.net> - 3.32.2-1.2
- Add !576 "Lists free cleanups" @f7ecf3b6
- Add !520 "clutter/stage-cogl: Don't skip over the next frame" @45244852
- Update !281 "clutter/stage-cogl: Reschedule update on present" @4faeb127
- Add !189 "Geometric (OpenGL-less) picking" @bfdf54fa
- Add !600 "Fix background texture corruption when resuming from suspend on Nvidia" @8b5060fe
- Un-revert !505 "background: Shrink wallpaper using LINEAR_MIPMAP_LINEAR"
- Update !575 "Honour `CLUTTER_ACTOR_NO_LAYOUT` more efficiently" @2b57d29d
- Add !602 "cogl: Remove GLX "threaded swap wait" used on Nvidia" @88ee2f51

* Thu May 16 2019 Yussuf Khalil <dev@pp3345.net> - 3.32.2-1.1
- Add !575 "Honour `CLUTTER_ACTOR_NO_LAYOUT` more efficiently" @1cf8772e
- Drop !283 "clutter-actor: Add detail to captured-event signal" (gnome-shell counterpart needs rebase)
- Rebase to 3.32.2-1.fc30
